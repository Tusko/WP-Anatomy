		...
		<form method="post" accept-charset="utf-8">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<fieldset>
							<legend class="screen-reader-text"><span>Maximum width and height</span></legend>
			...
			<p style="max-width:700px">Photos saved as PNG <?php //and GIF 
				?> images can be extremely large in file size due to their compression methods not being suited for photos. Enable these options below to automatically convert <?php //GIF and/or 
				?>PNG images to JPEG <strong>only if they don't have transparency</strong></strong>.</p>
